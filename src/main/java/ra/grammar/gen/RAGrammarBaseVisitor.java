...
/**
 * This class provides an empty implementation of {@link RAGrammarVisitor},
 ...
 */
public class RAGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements RAGrammarVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitValue(RAGrammarParser.ValueContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
